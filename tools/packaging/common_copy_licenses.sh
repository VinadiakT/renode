...
# Custom names for the 'license*' files. It should be a associative array but macOSs use bash3...
...
# Use target names without the '-license' suffix, e.g., 'renode' instead of 'LICENSE'. The order has
#   to be synced with the 'get_os_specific_licenses' function.
